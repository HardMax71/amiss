...
pub(super) struct WorkflowRunRecord {
    ...
    pub(super) conclusion: Option<crate::states::GitHubConclusion>,
...
pub(super) struct WorkflowRunQuery<'a> {
    ...
    pub(super) status: crate::states::GitHubConclusion,
...
pub(super) fn select_workflow_run(
    ...
    let valid = run.id > 0
        ...
        && run.conclusion == Some(crate::states::GitHubConclusion::Success)
