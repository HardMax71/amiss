...
pub const HUGO_CONFIG_SPELLINGS: [(&str, Staged<'static>); 8] = [
    ...
    (
        "nested/config/_default/hugo.toml",
        Staged::File(b"baseURL = \"https://example.test/\"\n"),
    ),
    (
    ...
    (
        "tool/config.yaml",
        Staged::File(b"baseURL: https://api.example.test/\n"),
    ),
    ("tool/docs/page.md", Staged::File(b"# Page\n\n[b](../b/)\n")),
    ("plain/config.yaml", Staged::File(b"name: plain\n")),
    (
