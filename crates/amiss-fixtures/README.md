...
data/github-webhook-issue-comment-event.json is the complete, unchanged
[issue-comment example with installation data](https://github.com/octokit/webhooks/blob/7dd7fa56498a827a08b71919fae89428f5e8e283/payload-examples/api.github.com/issue_comment/created.with-installation.payload.json).
It retains the issue, its label and milestone, the comment, repository,
organization, sender and installation together.
