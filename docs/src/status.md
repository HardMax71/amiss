...
| Semantic evidence | A separate 16 MiB envelope binds one external producer and at most 100,000 canonical observations to the exact candidate and optional source report. Unknown observation kinds are inert. No command, scanner intake, or provider verdict consumes this foundation yet. | [Contract](semantic-evidence.md) and [strict reader](https://github.com/HardMax71/amiss/blob/main/crates/amiss-wire/src/semantic.rs) |
