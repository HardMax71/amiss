...
opaque; leading-slash site routes without sealed build evidence, code symbols, live URLs, and
references to other repositories are not validated under those systems' semantics. Their visible
