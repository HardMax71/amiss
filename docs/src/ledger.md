...
[What thirteen renderers call a heading](anchor-rules.md), which is a separate study and not a
row on this page.
...
Heading anchors resolve since [What thirteen renderers call a heading](anchor-rules.md), so the
