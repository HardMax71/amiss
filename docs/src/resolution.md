...
exactly one exists and null otherwise, groundwork for the anchor fix. The union is deliberate: adding a rule can only grow what an anchor may match, and no
